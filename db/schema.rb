...
ActiveRecord::Schema.define(version: 20160410194330) do
  ...
  add_index "client_companies", ["user_id"], name: "index_client_companies_on_user_id", using: :btree
  ...
  add_foreign_key "client_companies", "users"
